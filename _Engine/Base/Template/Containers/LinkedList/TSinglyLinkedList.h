/*=============================================================================
//	File:	TSinglyLinkedList.h
//	Desc:	Singly linked list template.
=============================================================================*/
#pragma once
...
--------------------------------------------------------------
*/
template< class CLASS >	// where CLASS : TSinglyLinkedList< CLASS >
struct TSinglyLinkedList
{
	CLASS *		_next;	// the next item in a singly linked list, null if this is the last item
