...
public:
	...
	mxFORCEINLINE friend AStreamWriter& operator << ( AStreamWriter& file, const TKeyValue& o )
	{
		file << o.key << o.value;
		return file;
	}
	mxFORCEINLINE friend AStreamReader& operator >> ( AStreamReader& file, TKeyValue& o )
	{
		file >> o.key >> o.value;
		return file;
	}
