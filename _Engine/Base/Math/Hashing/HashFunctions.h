...
mxSWIPED("idLib, Doom3/Prey/Quake4 SDKs")
...
UINT64 MurmurHash64( const void* buffer, UINT32 sizeBytes, UINT32 seed = 0 );
...
{
	static mxFORCEINLINE UINT GetHashCode( const void* ptr )
	{
		#if (mxPOINTER_SIZE == 4)
		{
