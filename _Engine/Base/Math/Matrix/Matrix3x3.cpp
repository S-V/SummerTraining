...
mxBEGIN_STRUCT(Matrix3)
	mxMEMBER_FIELD(mColumns[0]),
	mxMEMBER_FIELD(mColumns[1]),
	mxMEMBER_FIELD(mColumns[2]),
mxEND_REFLECTION
...
============
*/
idQuat Matrix3::ToQuat( void ) const {
	idQuat		q;
	FLOAT		trace;
	FLOAT		s;
	FLOAT		t;
