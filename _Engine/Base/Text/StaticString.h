...
namespace StaticString_Util
{
	...
	{
	public:
		static mxFORCEINLINE void mxVPCALL Build( UINT & hash, INT strLen, const char* input )
		{
...
public:
	...
	mxFORCEINLINE const char* ToPtr() const
	{
		return mPtr;
	}
...
{
	static mxFORCEINLINE UINT GetHashCode( const StaticString& s )
	{
		return s.GetHash();
	}
};
...
{
	static mxFORCEINLINE bool Equals( const StaticString& a, const StaticString& b )
	{
		return (a == b);
	}
};
