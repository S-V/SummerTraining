...
//
mxDEFINE_KEYCODE( MOUSE1	),	// Left mouse button
mxDEFINE_KEYCODE( MOUSE2	),	// Right mouse button
mxDEFINE_KEYCODE( MOUSE3	),	// Middle mouse button
mxDEFINE_KEYCODE( MOUSE4	),	// Primary mouse thumb button.
mxDEFINE_KEYCODE( MOUSE5	),	// Secondary mouse thumb button.
mxDEFINE_KEYCODE( MOUSE6	),
mxDEFINE_KEYCODE( MOUSE7	),
mxDEFINE_KEYCODE( MOUSE8	),
mxDEFINE_KEYCODE( MOUSE9	),
mxDEFINE_KEYCODE( MOUSE10	),
mxDEFINE_KEYCODE( MOUSE11	),
mxDEFINE_KEYCODE( MOUSE12	),
mxDEFINE_KEYCODE( MOUSE13	),
mxDEFINE_KEYCODE( MOUSE14	),
mxDEFINE_KEYCODE( MOUSE15	),
mxDEFINE_KEYCODE( MOUSE16	),
