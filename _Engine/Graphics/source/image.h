...
struct PixelFormatInfo
{
	...
	UINT8	minBlockX;
	UINT8	minBlockY;
	//UINT8	components;		// number of components
	//UINT8	blockBytes;
	//UINT8	components;		// number of components
	UINT16	nativeFlags;	// e.g. IsSupported
	UINT16	nativeFormat;	// e.g. DXGI_FORMAT
};
extern PixelFormatInfo g_pixelFormats[PixelFormat::MAX];
#endif

	extern const ImageBlockInfo s_imageBlockInfo[];
